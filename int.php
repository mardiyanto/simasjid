...
elseif ($_GET[module]=='galery'){ ?>
  <div class="container-xxl py-5">
            ...
            <div class="text-center mx-auto pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <div class="row g-4">
                    <!-- BERITA Start -->
                    <?php $con=mysqli_query($koneksi, "SELECT * FROM galeri order by id_galeri DESC ");
	while($ar=mysqli_fetch_array($con)){
		?>
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                            <a class="d-block" href="foto/galleri/<?php echo"$ar[gambar]";?>" data-lightbox="gallery">
                            <img class="img-fluid" src="foto/galleri/<?php echo"$ar[gambar]";?>" alt="">
                            </a>
