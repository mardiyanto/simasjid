...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Jul 2023 pada 17.00
...
CREATE TABLE `sholat` (
  ...
  `shubuh` varchar(100) NOT NULL,
  `zuhur` varchar(100) NOT NULL,
  `ashar` varchar(100) NOT NULL,
  `maghrib` varchar(100) NOT NULL,
  `isya` varchar(100) NOT NULL
...
--
ALTER TABLE `sholat`
  MODIFY `id_waktu` int(10) NOT NULL AUTO_INCREMENT;
--
